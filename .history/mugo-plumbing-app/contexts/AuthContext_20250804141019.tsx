...
import { auth, db, enableFirestoreNetwork, disableFirestoreNetwork } from '../config/firebase';
...
export const AuthProvider: React.FC<AuthProviderProps> = ({ children }) => {
  ...
  const fetchUserProfile = async (userId: string) => {
    try {
      ...
      // Don't throw error, just log it and set offline state
